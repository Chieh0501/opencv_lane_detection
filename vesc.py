...
#Copy the class and instantiation to the final python script that are you are developing.

# Use the Vesc_object created to input the required steering and throttle as shown.
# Throttle should be given cautiously as even a throttle 0f 0.5 is high.
Vesc_object.run(0.10,0.0) #sample command first argument steering, second argument throttle
